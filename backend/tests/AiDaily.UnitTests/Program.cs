...
await AiDailyUnitTestRunner.RunAllAsync();
Console.WriteLine("AiDaily.UnitTests passed");

public sealed class AiDailyAcceptanceTests
{
    [Fact]
    public Task CurrentConsoleSuitePasses() => AiDailyUnitTestRunner.RunAllAsync();
}

internal static class AiDailyUnitTestRunner
{
